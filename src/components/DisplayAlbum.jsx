  ...
  return (
    <>
      ...
      <div className="mt-10 flex flex-col gap-8 md:flex-row md:items-end">
        ...
        <div className="flex flex-col text-white">
          ...
          <p className="mt-1">
            ...
            <b className="ms-2">Spotify</b> • 1,222,222 likes • <b>50 songs</b>, about 2hr 30 minutes
          </p>
        </div>
      </div>
      ...
      {songsData.map((item, index) => (
        <div onClick={() => playWithId(item.id)} key={index} className="grid grid-cols-3 gap-2 p-2 items-center sm:grid-cols-4 text-[#a7a7a7] hover:bg-[#ffffff2b] cursor-pointer">
